use crate::defaults::{
    default_preprocess_prompt, default_preprocess_template, DEFAULT_ANKI_ENDPOINT,
    DEFAULT_LLM_ENDPOINT, DEFAULT_LLM_MODEL, DEFAULT_MODEL_NAME,
};
...
pub struct AppSettings {
    ...
    #[serde(default = "default_preprocess_template")]
...
pub struct SyncSummary {
    ...
    pub anki_web_sync: AnkiWebSyncState,
    pub anki_web_sync_error: Option<String>,
}
...
fn default_anki_endpoint() -> String {
    DEFAULT_ANKI_ENDPOINT.to_string()
}
...
fn default_anki_preprocess_prompt_string() -> String {
    default_preprocess_prompt().to_string()
}
